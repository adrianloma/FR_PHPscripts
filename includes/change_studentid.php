...
if(isset($_POST['newStudent_id'])){
	$newStudent_id = $_POST['newStudent_id'];
}


//checks if id is taken
$query = mysqli_query($connect,"SELECT * FROM students WHERE student_id='$newStudent_id'");
$numrows = mysqli_num_rows($query);
//if a result is thrown
if($numrows == 1){
	$_SESSION['message'] = "Student ID is taken.";
	header("Location:  ../pages/main.php?page=ModifyStudent&modtype=3");
	exit;
}
